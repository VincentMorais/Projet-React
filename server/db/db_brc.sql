...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2145726794ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_brc&table=user">`db_brc`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_brc&table=event">`db_brc`.`event`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_brc&table=administrator">`db_brc`.`administrator`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_brc&table=customer">`db_brc`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_brc&table=shoes">`db_brc`.`shoes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_brc&table=ticket">`db_brc`.`ticket`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bd_zicmu&table=person">`bd_zicmu`.`person`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bd_zicmu&table=inscription">`bd_zicmu`.`inscription`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bd_zicmu&table=cours">`bd_zicmu`.`cours`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bd_zicmu&table=students">`bd_zicmu`.`students`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="70473045427646764b2a605b7b3b5e21">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="db_brc" targettable="shoes">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `shoes`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="shoes">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            targetdb="db_brc" targettable="ticket">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `db_brc`.`ticket` ( `customer_id` INT NOT NULL ,  `event_id` INT NOT NULL ,    PRIMARY KEY  (`customer_id`, `event_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="ticket">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `ticket`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="shoes">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `shoes` (`id`, `shoes_name`, `shoes_description`, `shoes_image`, `shoes_starting_price`) VALUES (NULL, &#039;Air Max&#039;, &#039;Collector&#039;, NULL, &#039;100&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="event">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `event`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="db_brc" targettable="event">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `event` (`id`, `shoes_id`, `ticket_price`, `starting_date`, `draw_time`, `nb_ticket`, `winner`) VALUES (NULL, &#039;1&#039;, &#039;&#039;, &#039;2022-07-02 00:00:00&#039;, &#039;2022-07-09 00:00:00&#039;, &#039;100&#039;, NULL);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="db_brc" targettable="event">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `event` (`id`, `shoes_id`, `ticket_price`, `starting_date`, `draw_time`, `nb_ticket`, `winner`) VALUES (NULL, &#039;1&#039;, &#039;10&#039;, &#039;2022-07-02 00:00:00&#039;, &#039;2022-07-09 00:00:00&#039;, &#039;100&#039;, NULL);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="event">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `ticket` (`customer_id`, `event_id`) VALUES (&#039;2&#039;, &#039;2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `event`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `customer`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="administrator">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `administrator`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_brc" targettable="event">
                            <div class="action_content">
